    ...
    <section className={s.container}>
      <div className={s.breadcrumbs}>
        ...
        {productState.categoryId && (
          <div className={s.crumbBox}>
            <Link
              to={`/categories/${productState.categoryId}`}
              className={s.crumbText}
            >
              {categoryName}
            </Link>
          </div>
      ...
      {productState ? (
        <div>
              ...
              <div className={s.descriptionBox}>
                ...
                <p className={s.descriptionText}>
                  ...
                  (productState.description &&
                    productState.description.length <= maxTextLength)
                    ? productState.description
                    : productState.description
          ...
          <div className={s.descriptionBoxHide}>
            <h3 className={s.descriptionTitleHide}>Description</h3>
            <p className={s.descriptionTextHide}>
              {isExpanded ||
              (productState.description &&
                productState.description.length <= maxTextLength)
                ? productState.description
